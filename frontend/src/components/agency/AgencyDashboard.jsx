...
const AgencyDashboard = () => {
  ...
  const setupOptimizedStyles = () => {
    ...
    style.textContent = `
      ...
      * {
      ...
      /* OTROS COMPONENTES - PADDING ESTÁNDAR */
      .chat-page, 
      .agency-escorts-manager,
      .agency-recruitment,
      .client-points-page,
      ...
      /* FORZAR RECALCULO DEL PADDING EN COMPONENTES */
      .feed-page,
      .chat-page,
      .agency-escorts-manager,
      .agency-recruitment,
      ...
      /* ✅ ASEGURAR QUE LOS MODALES ESTÉN CENTRADOS */
      .recruitment-modal,
      .notification-modal,
      .confirmation-modal,
  ...
  // ✅ FUNCIÓN PARA FORZAR VISIBILIDAD DE NAVBAR - COPIADA DE ESCORTDASHBOARD
  ...
  // Effect para manejar visibilidad - COPIADO DE ESCORTDASHBOARD
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <div 
      ...
      style={{
        ...
        minHeight: '100vh', // ✅ CAMBIO CRÍTICO: de height a minHeight
        display: 'flex',
        flexDirection: 'column',
        margin: 0,
        padding: 0,
        position: 'relative' // ✅ AGREGADO PARA CONTEXTO DE POSICIONAMIENTO
      }}
    >
      {/* Header Global */}
      <Header 
      ...
      <main 
        ...
        style={{
          ...
          perspective: 1000,
          // ✅ ARREGLO PARA MODALES: No restringir altura
          minHeight: 0 // ✅ ESTO PERMITE QUE EL CONTENIDO CREZCA LIBREMENTE
        }}
      >
        <AnimatePresence mode="wait">
          <motion.div
            ...
            style={{
              ...
              margin: 0,
              padding: 0,
              // ✅ ARREGLO PARA MODALES: Permitir que el contenido crezca
      ...
      {/* ✅ ENHANCED BOTTOM NAVIGATION BAR - AHORA CON 6 TABS */}
      <motion.nav
      ...
      >
        {/* Navigation Indicator Background - AHORA INCLUYE 6 BOTONES + EL BOTÓN EXTRA */}
        <div style={{
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          ...
          <motion.div
            ...
            style={{
              ...
              background: `linear-gradient(135deg, ${
                mainNavigation.find(item => item.id === activeView)?.gradient || 'from-orange-500 to-red-600'
              })`,
              borderRadius: '12px',
              opacity: 0.15,
              transform: `translateX(${mainNavigation.findIndex(item => item.id === activeView) * (60 + 12)}px)`,
              transition: 'all 0.5s cubic-bezier(0.23, 1, 0.320, 1)',
              boxShadow: '0 6px 24px rgba(255, 107, 53, 0.3)' // Color agencia
            }}
          />
          ...
          {mainNavigation.map((item, index) => {
            ...
            return (
              <motion.button
                ...
                onClick={() => {
                  console.log(`Agencia navegando a: ${item.label}`);
              ...
              >
                <motion.div 
                  ...
                  style={{
                    ...
                    boxShadow: isActive 
                      ? '0 6px 20px rgba(255, 107, 53, 0.4)' // Color agencia
          ...
          {[...Array(6)].map((_, i) => (
            <div
              ...
              style={{
                ...
                height: '3px',
                borderRadius: '50%',
                background: 'rgba(255, 107, 53, 0.6)', // Color agencia
      ...
      {/* ✅ ENHANCED CSS STYLES - RESPONSIVE PARA 6 TABS */}
      <style jsx>{`
        .enhanced-bottom-nav {
          --nav-height: 52px;
        }
        ...
        /* DESKTOP - Ajuste de ancho para 6 botones + botón extra */
        @media (min-width: 1024px) {
          .enhanced-bottom-nav.mobile-forced {
        ...
        /* TABLET Y MÓVIL - Ajustado para 6 tabs */
        @media (max-width: 1023px) {
          ...
          .enhanced-bottom-nav.mobile-forced::-webkit-scrollbar {
            display: none !important;
          }
        ...
        @media (max-width: 480px) {
          ...
          .nav-indicator-bg {
            ...
            top: 7px !important;
            transform: translateX(calc(var(--active-index) * 39px)) !important;
          }
        ...
        .enhanced-nav-tab:hover .icon-container {
          ...
          box-shadow: 0 8px 20px rgba(255, 107, 53, 0.5); /* Color agencia */
        }
        ...
        @media (max-width: 768px) {
          ...
          .enhanced-nav-tab:hover .icon-container {
            ...
            box-shadow: 0 4px 16px rgba(255, 107, 53, 0.4); /* Color agencia */
          }
