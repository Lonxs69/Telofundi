...
-- CreateEnum
CREATE TYPE "InteractionType" AS ENUM ('VIEW', 'LIKE', 'CHAT', 'PROFILE_VISIT', 'POST_CLICK', 'FAVORITE', 'SHARE', 'REPORT', 'BOOST_VIEW', 'CONTACT_CLICK', 'IMAGE_VIEW', 'PHONE_VIEW', 'LOCATION_VIEW', 'WHATSAPP_CLICK', 'WHATSAPP_OPEN', 'TIME_SPENT', 'DISCOVERY_VIEW', 'POST_DETAIL_VIEW', 'UNLIKE', 'UNFAVORITE');
...
-- CreateIndex
CREATE INDEX "clients_chatPriorityUntil_idx" ON "clients"("chatPriorityUntil");
...
-- CreateIndex
CREATE INDEX "posts_age_idx" ON "posts"("age");

-- CreateIndex
CREATE INDEX "posts_location_idx" ON "posts"("location");

-- CreateIndex
CREATE INDEX "posts_sexo_idx" ON "posts"("sexo");
...
-- CreateIndex
CREATE INDEX "boosts_amount_isActive_idx" ON "boosts"("amount", "isActive");
