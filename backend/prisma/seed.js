...
async function main() {
  ...
  try {
    ...
    // 2. Crear paquetes de puntos - ✅ TODOS A $1.00 PARA TESTING
    console.log('💰 Creando paquetes de puntos (TESTING - $1.00)...');
    await prisma.pointsPackage.createMany({
      data: [
        {
          name: 'Test Starter',
          points: 50,
          price: 1.00, // ✅ CAMBIADO: De $4.99 a $1.00
          bonus: 5,
          description: 'Paquete de prueba - 50 puntos + 5 bonus'
        },
        {
          name: 'Test Basic',
          points: 100,
          price: 1.00, // ✅ CAMBIADO: De $9.99 a $1.00
          bonus: 15,
          isPopular: true,
          description: 'Paquete de prueba - 100 puntos + 15 bonus'
        },
        {
          name: 'Test Premium',
          points: 250,
          price: 1.00, // ✅ CAMBIADO: De $19.99 a $1.00
          bonus: 50,
          description: 'Paquete de prueba - 250 puntos + 50 bonus'
        },
        {
          name: 'Test Mega',
          points: 500,
          price: 1.00, // ✅ CAMBIADO: De $34.99 a $1.00
          bonus: 125,
          description: 'Paquete de prueba - 500 puntos + 125 bonus'
        },
        {
          name: 'Test Mini',
          points: 25,
          price: 1.00, // ✅ AGREGADO: Paquete extra para más opciones de testing
          bonus: 2,
          description: 'Paquete de prueba mínimo - 25 puntos + 2 bonus'
        }
      ]
    });
    console.log('✅ 5 paquetes de puntos creados - TODOS A $1.00 PARA TESTING');

    // 3. Crear precios de boost - ✅ TAMBIÉN A $1.00 PARA TESTING
    console.log('🚀 Creando precios de boost (TESTING - $1.00)...');
    await prisma.boostPricing.createMany({
      data: [
        ...
        },
        {
          type: 'FEATURED',
          duration: 72,
          price: 1.00, // ✅ CAMBIADO: De $29.99 a $1.00
          multiplier: 2.5,
    ...
    console.log('✅ 3 precios de boost creados - TODOS A $1.00 PARA TESTING');

    // 4. Crear precios de verificación - ✅ TAMBIÉN A $1.00
    console.log('✅ Creando precios de verificación (TESTING - $1.00)...');
    await prisma.verificationPricing.createMany({
      data: [
        {
          name: 'Test Verificación Básica',
          cost: 1.00, // ✅ CAMBIADO: De $25.00 a $1.00
          description: 'Verificación de prueba básica por 30 días',
          features: ['Verificación de ID', 'Badge verificado'],
          duration: 30
        },
        {
          name: 'Test Verificación Premium',
          cost: 1.00, // ✅ CAMBIADO: De $50.00 a $1.00
          description: 'Verificación de prueba completa por 30 días',
          features: ['Verificación completa', 'Badge premium'],
          duration: 30
        }
      ]
    });
    console.log('✅ 2 precios de verificación creados - TODOS A $1.00 PARA TESTING');
    ...
    console.log('   💰 5 paquetes de puntos (TODOS A $1.00 - TESTING)');
    console.log('   🚀 3 precios de boost (TODOS A $1.00 - TESTING)');
    console.log('   ✅ 2 precios de verificación (TODOS A $1.00 - TESTING)');
    ...
    console.log('   ✅ Todos los paquetes cuestan $1.00');
    console.log('   ✅ Todos los boosts cuestan $1.00');
    console.log('   ✅ Todas las verificaciones cuestan $1.00');

    console.log('\n🎯 Sistema TeloPoints configurado y listo para testing!');
