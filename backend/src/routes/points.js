...
// Importar controladores - ✅ CORREGIDO: Agregar getPackages
const {
  getPointsBalance,
  getPointsHistory,
  getPointsPackages,
  getPackages, // ✅ NUEVA FUNCIÓN AGREGADA
  getDailyLoginStatus,
  claimDailyPoints,
  getStreakInfo,
  purchasePoints,
 ...
 *         description: Solo clientes pueden acceder
 */
router.get('/history', validatePagination, getPointsHistory);
 ...
 * /api/points/packages:
 *   get:
 *     summary: Obtener paquetes de puntos disponibles (versión completa)
 *     description: Obtiene todos los paquetes de puntos disponibles para comprar con información completa
 *     tags: [Points]
 *     security:
 *       - bearerAuth: []
 *     responses:
...
/**
 * @swagger
 * /api/points/packages-simple:
 *   get:
 *     summary: Obtener paquetes de puntos disponibles (versión simplificada)
 *     description: Obtiene todos los paquetes de puntos disponibles para comprar en formato simplificado
 *     tags: [Points]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *                   format: date-time
 */
router.get('/packages-simple', getPackages); // ✅ NUEVA RUTA AGREGADA
 ...
 */
router.get('/daily-status', getDailyLoginStatus);
