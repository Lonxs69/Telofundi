...
const {
  ...
  googleAuth,
  googleCallback,
  verifyTempToken, // ✅ NUEVO: Importar función para verificar token temporal
  testEmail
 ...
 *     responses:
 *       302:
 *         description: Redirección al frontend con token temporal
 *       400:
...
/**
 * @swagger
 * /api/auth/callback/verify/{tempToken}:
 *   get:
 *     summary: Verificar token temporal de OAuth
 *     tags: [Auth]
 *     parameters:
 *       - in: path
 *         name: tempToken
 ...
 *         schema:
 *           type: string
 *         description: Token temporal único generado después del OAuth
 *         example: "a1b2c3d4e5f6..."
 *     responses:
 *       200:
 *         description: Token verificado exitosamente, datos de autenticación devueltos
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/TempTokenResponse'
 *       404:
 *         description: Token temporal no válido o expirado
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Token temporal no válido o expirado"
 *                 errorCode:
 *                   type: string
 *                   example: "INVALID_TEMP_TOKEN"
 */
// ✅ NUEVA RUTA: Verificar token temporal de OAuth
router.get('/callback/verify/:tempToken', verifyTempToken);
