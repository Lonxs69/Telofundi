 ...
 *         description:
 *           type: string
 *           example: "Paquete perfecto para usuarios regulares"
 *         isActive:
 *           type: boolean
 *           example: true
 *     
 ...
 *     responses:
 *       200:
 *         description: Paquetes de puntos obtenidos exitosamente
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/points/packages', authenticate, getPointsPackages);
